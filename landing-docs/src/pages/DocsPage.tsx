...
const coreAgents = [
  {
    name: "Intent Router",
    description:
      "Classifies incoming user inputs and determines the appropriate system response. Handles classification of questions, commands, reflections, observations, and noise filtering.",
    icon: Target,
    color: "violet",
  },
  {
    name: "Memory Manager",
    description:
      "Handles short-term and long-term memory lifecycle including ingestion, vectorization, summarization, indexing, and garbage collection.",
    icon: Database,
    color: "blue",
  },
  {
    ...
    description:
      "Fetches relevant memories based on context using hybrid search combining vector similarity, keyword matching, and temporal filters.",
    icon: Search,
    color: "cyan",
  },
  {
    name: "Tool Executor",
    description:
      "Safely executes external operations including browser automation, HTTP API calls, MCP server invocation, and custom Python tools in a sandboxed environment.",
    icon: Wrench,
    color: "orange",
  },
  {
    name: "LLM Router",
    description:
      "Determines which AI model to use based on task complexity, optimizes for cost, and manages context windows across different providers.",
    icon: Cpu,
    color: "pink",
  },
  {
    ...
    description:
      "Generates high-quality summaries at multiple time scales from daily to yearly, with bidirectional links to source segments.",
    icon: FileText,
    color: "emerald",
  },
  {
    name: "Noise Filter",
    description:
      "Distinguishes meaningful interactions from background noise using speaker analysis, semantic relevance assessment, and confidence scoring.",
    icon: Volume2,
    color: "amber",
  },
  {
    ...
    description:
      "Analyzes memories proactively to provide health, productivity, and wellbeing suggestions. Runs twice daily with a dedicated health check mode.",
    icon: Heart,
    color: "red",
  },
];
...
const backgroundAgents = [
  {
    ...
    schedule: "Every 24h",
    description: "Generates daily summaries and extracts key insights",
  },
  {
    name: "Weekly Summary",
    schedule: "Weekly",
    description: "Aggregates 7-day summaries and identifies trends",
  },
  {
    name: "Goal Tracker",
    schedule: "Continuous",
    description: "Monitors progress on long-term goals",
  },
  {
    name: "Habit Analyzer",
    schedule: "Daily",
    description: "Tracks recurring behaviors and measures consistency",
  },
  {
    name: "Knowledge Gap Detector",
    schedule: "Weekly",
    description: "Identifies missing information and suggests resources",
  },
];
...
const memoryTimeScales = [
  {
    ...
    description: "Complete interactions from the past 24 hours",
  },
  {
    label: "3-Day",
    retention: "High detail",
    description: "Compressed view of recent activity",
  },
  {
    label: "Weekly",
    retention: "Key events",
    description: "Important decisions and milestones",
  },
  {
    label: "Bi-weekly",
    retention: "Summaries",
    description: "Consolidated insights from two weeks",
  },
  {
    label: "Monthly",
    retention: "Themes",
    description: "Major topics and patterns",
  },
  {
    label: "Quarterly",
    retention: "Trends",
    description: "Long-term patterns and progress",
  },
  {
    label: "6-Month",
    retention: "Highlights",
    description: "Significant achievements and changes",
  },
  {
    label: "Yearly",
    retention: "Overview",
    description: "Annual review and reflections",
  },
  {
    label: "Multi-year",
    retention: "Life events",
    description: "Major life milestones and evolution",
  },
];
...
const builtInTools = [
  ...
  },
  {
    ...
    actions: "navigate, click, extract",
  },
  {
    name: "memory_search",
    description: "Search user's memories",
    actions: "search, get_context",
  },
  {
    name: "secrets",
...
const apiEndpoints = [
  ...
  },
  {
    method: "GET",
    path: "/api/memories",
    description: "List user memories with filters",
  },
  ...
  {
    method: "POST",
    path: "/api/speakers/enroll",
    description: "Enroll new speaker profile",
  },
  {
    method: "POST",
    path: "/api/speakers/identify",
    description: "Identify speaker from audio",
  },
  {
    method: "POST",
    path: "/api/proactive/analyze",
    description: "Run proactive analysis",
  },
  {
    method: "GET",
    path: "/api/proactive/status",
    description: "Get proactive agent status",
  },
  {
    method: "POST",
          ...
          <main className="flex-1 min-w-0 pb-24 space-y-24">
            ...
            <section id="overview" className="scroll-mt-24">
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-lg text-zinc-600">
                  An AI-powered personal cognitive operating system that
                  captures, organizes, summarizes, and recalls information to
                  augment human memory and decision-making. Built with
                ...
                <div className="p-6 mt-6 border rounded-xl border-zinc-200 bg-zinc-50">
                  ...
                  <ul className="grid gap-3 mt-4 sm:grid-cols-2">
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      ...
                      <span>
                        <strong>Continuously captures</strong> information from
                        voice, text, and tool interactions
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                      <span>
                        <strong>Organizes & structures</strong> data with
                    ...
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                      <span>
                        <strong>Generates summaries</strong> at multiple time
                        scales (daily → yearly)
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                      <span>
                        <strong>Enables retrieval</strong> through semantic
                        search and chat
                      </span>
                    </li>
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                      <span>
                        <strong>Provides coaching</strong> for health,
                    ...
                    <li className="flex items-start gap-2 text-sm text-zinc-600">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                      <span>
                        <strong>Maintains privacy</strong> with local-first,
            ...
            <section id="quickstart" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                The interactive setup script handles everything from dependency
                checks to Docker configuration. Just two commands to get
                started.
              </p>
              ...
              <div className="p-4 mt-6 border rounded-xl border-amber-200 bg-amber-50">
                ...
                <ul className="mt-2 space-y-1 text-sm text-amber-800">
                  <li>
                    ...
                    <strong>Docker Compose</strong> installed
                  </li>
                  <li>
                    • <strong>Node.js 18+</strong> (for local development)
                  </li>
                  <li>
              ...
              <div className="p-4 mt-6 border rounded-xl border-emerald-200 bg-emerald-50">
                ...
                <p className="mt-2 text-sm text-emerald-800">
                  ...
                  to access your Second Brain dashboard.
                </p>
                <div className="grid gap-2 mt-3 text-sm text-emerald-800 sm:grid-cols-2">
                  ...
                  <div>
                    <strong>PostgreSQL:</strong> localhost:5432
                  </div>
                  <div>
                    <strong>Weaviate:</strong> http://localhost:8080
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4 mt-4 sm:grid-cols-2">
                ...
                <div className="p-4 bg-white border rounded-lg border-zinc-200">
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-zinc-600">
                    <li>
                      • <strong>Local AI:</strong> Run{" "}
                      <code className="px-1 text-xs rounded bg-zinc-100">
                        ./scripts/setup-local-llm.sh
                      </code>
                    </li>
                    <li>
                      • <strong>Cloud AI:</strong> Configure OpenAI/Anthropic in
                      Settings
                    </li>
              ...
              <div className="mt-4">
                <CodeBlock
                  code={`# 1. Copy environment template
cp .env.example .env
...
# Terminal 2: npm run dev`}
            ...
            <section id="features" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                A comprehensive personal AI system designed to capture,
                organize, and retrieve information to augment your memory and
                decision-making.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Captures interactions and structures them automatically",
                  },
                  {
                    icon: Mic,
                    label: "Voice Recognition",
                    desc: "ECAPA-TDNN speaker recognition, fully local",
                  },
                  {
                    icon: Search,
                    label: "Semantic Search",
                    desc: "Find memories by meaning using vector embeddings",
                  },
                  {
                    icon: Shield,
                    label: "Privacy-First",
                    desc: "Self-hosted, encrypted storage, zero telemetry",
                  },
                  {
                    icon: Clock,
                    label: "Multi-Scale Summaries",
                    desc: "From daily to yearly timescales",
                  },
                  {
                    icon: Bot,
                    label: "Autonomous Agents",
                    desc: "Background processes for reflection and goals",
                  },
                  {
                    icon: Heart,
                    label: "Proactive Coaching",
                    desc: "AI that analyzes patterns for health & productivity",
                  },
                  {
                    icon: Wrench,
                    label: "Tool Integration",
                    desc: "Browser automation, APIs, custom tools",
                  },
                  {
                    icon: MessageSquare,
                    label: "Smart Chat",
                    desc: "Conversational interface with memory context",
                  },
                  {
                    icon: Bell,
                    label: "Notifications",
                    desc: "Multi-channel alerts including Pushover support",
                  },
                  {
                    icon: Cpu,
                    label: "Flexible AI Models",
                    desc: "OpenAI, Anthropic, Gemini, or local models",
                  },
                  {
                    icon: Globe,
                    label: "Telegram Integration",
                    desc: "Chat and control via Telegram bot",
                  },
                ].map(({ icon: Icon, label, desc }) => (
                  <div
                    key={label}
                    className="flex gap-3 p-4 border rounded-lg border-zinc-200 bg-zinc-50"
                  >
            ...
            <section id="architecture" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Built on a modern microservices architecture with clear
                separation of concerns. Every component is designed to work
                independently while integrating seamlessly.
              </p>
              ...
              <div className="p-6 mt-8 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <div className="grid gap-4 mt-4 sm:grid-cols-2 lg:grid-cols-3">
                  {[
                    ...
                    {
                      layer: "Vector DB",
                      tech: "Weaviate (semantic search)",
                      icon: Search,
                    },
                    { layer: "ORM", tech: "Prisma", icon: Code },
                    {
                      layer: "LLM",
                      tech: "OpenAI, Anthropic, Local models",
                      icon: Cpu,
                    },
              ...
              <div className="p-6 mt-6 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <div className="mt-4 overflow-x-auto">
                  <CodeBlock
                    code={`User Input → Intent Router → Memory Retrieval → LLM Router → Tool Executor
     ↓              ↓              ↓              ↓              ↓
...
└── docs/                   # Markdown documentation`}
            ...
            <section id="agents" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Second Brain uses a multi-agent architecture where specialized
                agents handle different aspects of memory management, reasoning,
                and automation.
              </p>
              ...
              <div className="grid gap-4 mt-4 sm:grid-cols-2">
                {coreAgents.map((agent) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-lg bg-${agent.color}-100 text-${agent.color}-600`}
                      >
              ...
              <p className="mt-2 text-sm text-zinc-600">
                These agents run autonomously on schedules to maintain and
                enhance your memory system.
              </p>
              <div className="mt-4 overflow-hidden border rounded-xl border-zinc-200">
                <table className="w-full text-sm">
                  <thead className="bg-zinc-50">
                    <tr>
                      <th className="px-4 py-3 font-medium text-left text-zinc-900">
                        Agent
                      </th>
                      <th className="px-4 py-3 font-medium text-left text-zinc-900">
                        Schedule
              ...
              <div className="p-6 mt-8 border-2 border-violet-200 rounded-xl bg-violet-50">
                ...
                <p className="mt-2 text-sm text-violet-800">
                  A unique AI coach that analyzes your memories to provide
                  gentle, non-invasive suggestions for health, productivity, and
                  wellbeing. Runs twice daily (8 AM and 6 PM) with dedicated
                  health checks on Mondays and Thursdays.
                </p>
            ...
            <section id="memory" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Memories are organized in a hierarchical system with progressive
                summarization, ensuring both detailed recall and high-level
                insights across different time horizons.
              </p>
              ...
              <div className="grid gap-6 mt-8 md:grid-cols-2">
                ...
                <div className="p-6 bg-white border rounded-xl border-zinc-200">
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-zinc-600">
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500" />9
                      time scales: daily to multi-year
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 mt-0.5 text-emerald-500" />
              ...
              {/* Time Scales */}
              <h3 className="mt-8 text-lg font-semibold text-zinc-900">
                Time Scale Summaries
              </h3>
              <p className="mt-2 text-sm text-zinc-600">
                Memories are automatically summarized at multiple time scales
                for efficient retrieval and insights.
              </p>
              <div className="flex flex-wrap gap-2 mt-4">
                {memoryTimeScales.map((scale, i) => {
                  ...
                  return (
                    <div
                      key={scale.label}
                      className="p-3 bg-white border rounded-lg border-zinc-200"
                    >
                      <span
                        className={`text-xs font-semibold text-${colors[i % colors.length]}-600`}
                      >
                        {scale.label}
                      </span>
              ...
              <div className="p-6 mt-8 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                  Memory retrieval combines multiple search strategies for
                  optimal results:
                </p>
                  ...
                  {[
                    {
                      ...
                      desc: "Find semantically similar memories using embeddings",
                    },
                    {
                      name: "Keyword Match",
                      desc: "Exact and fuzzy text matching for precision",
                    },
                    {
                      name: "Temporal Filters",
                      desc: "Time-based queries for historical context",
                    },
                  ].map((method) => (
                    <div
                      key={method.name}
            ...
            <section id="tools-skills" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                The system distinguishes between <strong>Tools</strong> (atomic
                actions) and <strong>Skills</strong> (complex workflows) to
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-zinc-100">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-zinc-600">
                        Direct code execution (~100ms)
                      </td>
                      <td className="px-4 py-3 text-zinc-600">
                        AI interprets and follows (seconds)
                      </td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-medium text-zinc-900">
                      ...
                      <td className="px-4 py-3 text-zinc-600">
                        <code className="px-1 rounded bg-zinc-100">
                          get_weather("Paris")
                        </code>
                      </td>
                      <td className="px-4 py-3 text-zinc-600">
                        "Alert me if it will snow"
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="grid gap-3 mt-4 sm:grid-cols-2">
                {builtInTools.map((tool) => (
                  <div
                    key={tool.name}
                    className="p-4 bg-white border rounded-lg border-zinc-200"
                  >
                    <code className="px-2 py-1 text-sm font-medium rounded bg-zinc-100 text-zinc-900">
                      {tool.name}
                    </code>
                    <p className="mt-2 text-sm text-zinc-600">
                      {tool.description}
              ...
              <div className="p-6 mt-8 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                  The AI can generate custom Python tools dynamically to perform
                  specialized tasks. Tools are executed in a sandboxed
                  environment for security.
                </p>
                <div className="mt-4">
                  <CodeBlock
                    code={`# Example: Custom weather tool (generated by AI)
import requests
import os
    ...
    return {
        ...
        "description": data["weather"][0]["description"]
              ...
              <div className="p-6 mt-6 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                  Skills are natural language workflows that the AI interprets
                  and executes using available tools.
                </p>
                <div className="mt-4">
                  <CodeBlock
                    code={`# Weather Alert Skill (Markdown)
---
...
4. **Send notification** only if relevant conditions are detected`}
            ...
            <section id="voice" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Second Brain includes sophisticated audio processing
                capabilities including speaker recognition, voice activity
                detection, and continuous listening modes.
              </p>
              ...
              <div className="grid gap-6 mt-8 md:grid-cols-2">
                <div className="p-6 bg-white border rounded-xl border-zinc-200">
                  ...
                  <p className="mt-2 text-sm text-zinc-600">
                    ECAPA-TDNN model for reliable speaker identification. Enroll
                    speakers with a few audio samples for personalized memory
                    attribution.
                  </p>
                  <ul className="mt-3 space-y-2 text-sm text-zinc-600">
                    <li className="flex items-start gap-2">
                ...
                <div className="p-6 bg-white border rounded-xl border-zinc-200">
                  ...
                  <p className="mt-2 text-sm text-zinc-600">
                    Intelligent detection of speech vs. silence for efficient
              ...
              <div className="grid gap-4 mt-4 sm:grid-cols-3">
                {[
                  {
                    name: "Text Input",
                    desc: "Lowest latency, direct processing",
                    latency: "<100ms",
                  },
                  {
                    name: "Audio Stream",
                  ...
                  {
                    name: "Audio Batch",
                    desc: "3-10s chunks for mobile/IoT",
                    latency: "<3s",
                  },
                ].map((format) => (
                  <div
            ...
            <section id="notifications" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                ...
                with real-time delivery and intelligent routing.
              </p>
              ...
              <div className="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  {
                    name: "In-App",
                    desc: "Real-time WebSocket notifications",
                    icon: Monitor,
                  },
                  {
                    name: "Browser Push",
                    desc: "Native browser notifications with Service Worker",
                    icon: Bell,
                  },
                  {
                    name: "Pushover",
                    desc: "Mobile notifications for iOS, Android, Desktop",
                    icon: MessageSquare,
                  },
                  {
                    name: "Email",
                    desc: "Email notifications (future)",
                    icon: FileText,
                  },
                  {
                    name: "Webhook",
                    desc: "Custom HTTP webhooks",
                    icon: Globe,
                  },
                  {
                    name: "Telegram",
                    desc: "Chat notifications via Telegram bot",
                    icon: MessageSquare,
                  },
                ].map(({ name, desc, icon: Icon }) => (
                  <div
                    key={name}
                    className="flex gap-3 p-4 bg-white border rounded-lg border-zinc-200"
                  >
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {[
                  ...
                  <span
                    key={type}
                    className={`px-3 py-1 text-sm font-medium rounded-full bg-${color}-100 text-${color}-700`}
                  >
                    {type}
                  </span>
                ))}
              ...
              <div className="p-6 mt-8 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                  When Pushover is configured, the system automatically routes
                  notifications to your mobile devices for better delivery. This
                  is transparent to the AI—it simply sends notifications and the
                  system chooses the optimal channel.
                </p>
              </div>
            </section>
            ...
            <section id="api" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                All API endpoints require JWT authentication via the{" "}
                <code className="px-1 rounded bg-zinc-100">
              ...
              <div className="p-6 mt-8 border rounded-xl border-zinc-200 bg-zinc-50">
                ...
                <div className="mt-4">
                  <CodeBlock
                    code={`curl -X POST http://localhost:3000/api/notifications \\
  ...
  -d '{
    ...
    "channels": ["IN_APP", "PUSH"]
            ...
            <section id="configuration" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Configure Second Brain using environment variables. Copy{" "}
                <code className="px-1 rounded bg-zinc-100">.env.example</code>{" "}
                to <code className="px-1 rounded bg-zinc-100">.env</code> and
                customize.
              </p>
...
TELEGRAM_BOT_TOKEN=your-telegram-bot-token`}
              ...
              <div className="grid gap-4 mt-4 md:grid-cols-2">
                <div className="p-6 bg-white border rounded-xl border-zinc-200">
                  ...
                  <p className="mt-2 text-sm text-zinc-600">
                    Run AI models completely locally using Ollama. Best for
                    sensitive data.
                  </p>
                  <div className="mt-4">
                ...
                <div className="p-6 bg-white border rounded-xl border-zinc-200">
                  ...
                  <p className="mt-2 text-sm text-zinc-600">
                    Use cloud providers like OpenAI, Anthropic, or Google.
            ...
            <section id="security" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Second Brain is designed with privacy as a core principle. Your
                data stays under your control at all times.
              </p>
              ...
              <div className="grid gap-4 mt-8 sm:grid-cols-2">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Secure token-based authentication with 7-day expiry",
                  },
                  {
                    icon: Shield,
                    title: "AES-256-GCM Secrets",
                    desc: "API keys and secrets encrypted with AES-256-GCM",
                  },
                  {
                    icon: Server,
                    title: "Local-First Architecture",
                    desc: "All processing can run on your own infrastructure",
                  },
                  {
                    icon: User,
                    title: "User-Scoped Data",
                    desc: "Complete data isolation between users",
                  },
                  {
                    icon: FileText,
                    title: "Audit Logging",
                    desc: "Every read/write operation is logged",
                  },
              ...
              <div className="p-6 mt-8 border-2 border-emerald-200 rounded-xl bg-emerald-50">
                ...
                <p className="mt-2 text-sm text-emerald-800">
                  Second Brain does not collect any usage data, analytics, or
                  telemetry. Your interactions, memories, and patterns are never
                  sent to external servers. When using local LLM models, your
            ...
            <section id="roadmap" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Second Brain is actively developed with a clear vision for the
                future.
              </p>
              ...
              <div className="mt-8 space-y-6">
                {[
                  ...
                  <div
                    key={phase.phase}
                    className="p-6 bg-white border rounded-xl border-zinc-200"
                  >
                    ...
                    <ul className="grid gap-2 mt-4 sm:grid-cols-2">
                      {phase.items.map((item) => (
                        ...
                        >
                          <Check
                            className={`w-4 h-4 ${phase.status === "complete" ? "text-emerald-500" : "text-zinc-300"}`}
                          />
                          {item}
                        </li>
                      ))}
            ...
            <section id="faq" className="scroll-mt-24">
              ...
              <p className="mt-2 text-zinc-600">
                Common questions about Second Brain.
              </p>
