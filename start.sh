...
show_menu() {
    ...
    print_color "$CYAN" "  ║   ${GREEN}6)${NC}${CYAN} $ICON_KEY Regenerate secrets                  ║"
    print_color "$CYAN" "  ║   ${GREEN}7)${NC}${CYAN} $ICON_GEAR Re-run dependency check             ║"
    print_color "$CYAN" "  ║   ${GREEN}8)${NC}${CYAN} $ICON_CLEAN Clean up (remove all data)         ║"
    print_color "$CYAN" "  ║   ${GREEN}9)${NC}${CYAN} 🚪 Exit                                ║"
    print_color "$CYAN" "  ║                                               ║"
    print_color "$CYAN" "  ╚═══════════════════════════════════════════════╝"
    echo
}
