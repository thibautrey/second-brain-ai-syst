...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_memories_user_time" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_memories_user_pinned" 
ON "memories" ("userId") 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_memories_user_type" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_summaries_user_timescale" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_processed_inputs_user_time" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_ai_task_config_user_task" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_scheduled_tasks_user_enabled" 
ON "scheduled_tasks" ("userId", "enabled", "nextRun");

-- Index for todos by user and completion status
-- Used for: Active todo list
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_todos_user_completed" 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_memories_recent_hot" 
